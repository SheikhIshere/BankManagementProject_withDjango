...
# SECRET_KEY = 'django-insecure-_d^^vdy7@vsq9%=6^=+$=l*++$tz&t9is!!37)ls6m@52ww8f1'
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgresql://mamarbank_database_postgres_user:23ida7Cq7B9gN4Qc4cwUBAAp74fbAobG@dpg-d15f1ap5pdvs73f8afqg-a.oregon-postgres.render.com/mamarbank_database_postgres'
...
# Base directory (keep this)
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))

# Static files settings (update only this part)
STATIC_URL = 'static/'
STATICFILES_DIRS = [
